...
class ActionFilmsInform(Action):
    ...
    def run(
        ...
        # mongodb+srv://ana-compass:starwars123@apicluster.zyhrttc.mongodb.net/?retryWrites=true&w=majority
        ...
        if int(film_name) > 6 or int(film_name) < 1:
            ...
            #Verifica se esse usuário já possui uma infomação no
            #if collection.count_documents({'user':name}):
